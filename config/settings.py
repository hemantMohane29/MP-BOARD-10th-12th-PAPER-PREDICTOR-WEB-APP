...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-xfdf!h^(a6^-&pp9f52ebn68r^=xc0ra7-y)gr21^5y5@9aghr')
...
# Sessions — cookie-based, no DB or file required
SESSION_ENGINE = 'django.contrib.sessions.backends.signed_cookies'

# Database — /tmp is writable on Render at runtime
DATABASES = {
    'default': {
